<template>
  <div>
    ...
    <div class="container" v-if="!showEdit">
      <div class="header"><div class="title">我的收藏</div></div>
      <!-- 表格 -->
      <el-table stripe v-loading="loading" :data="tableData">
        ...
        <el-table-column fixed="right" label="操作">
          <template slot-scope="scope">
            ...
            <el-button @click.prevent="handleDelete(scope.row)" type="danger" plain size="mini">取消收藏</el-button>
          </template>
        </el-table-column>
      </el-table> 
    ...
    <!-- 详情页 -->
    <position-detail v-else @detailClose="detailClose" :detailPositionID="detailPositionID" :flag="false"></position-detail>
  </div>
</template>
