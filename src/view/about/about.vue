<template>
  <div class="container" v-if="!showDetail && !showHot">
    <div class="header">
      <div class="title">欢迎来到智能招聘系统</div>
    </div>
    <!-- 搜索框 -->
    <div class="box">
      <div class="left">
    ...
    <transition name="fade">
      <div class="search" v-if="keyword">
        <p class="search-tip">
          搜索“<span class="search-keyword">{{ keyword }}</span>”, 找到 <span class="search-num">{{ totalNums }}</span> 条职位信息
        </p>
  ...
  <!-- 职位详情 -->
  <position-detail v-else-if="showDetail && !showHot" @detailClose="detailClose" :detailPositionID="detailPositionID" :temp="1"></position-detail>
  <!-- 热招职位 -->
