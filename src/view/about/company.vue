<template>
  <div class="container" v-if="!showDetail">
    <div class="header">
      <div class="title">智能招聘系统——公司大全</div>
    </div>
    <!-- 搜索框 -->
    <div class="box">
      <div class="left">
    ...
    <transition name="fade">
      <div class="search" v-if="keyword">
        <p class="search-tip">
          搜索“<span class="search-keyword">{{ keyword }}</span>”, 找到 <span class="search-num">{{ totalNums }}</span> 条公司信息
        </p>
    ...
    <el-table stripe v-loading="loading" :data="tableData">
      ...
      <el-table-column fixed="right" label="操作">
        <template slot-scope="scope">
          ...
          <el-button @click.prevent="handleFollow(scope.row)" v-permission="{permission:'新增关注'}" type="success" plain size="mini">关注公司</el-button>
        </template>
      </el-table-column>
    </el-table>
