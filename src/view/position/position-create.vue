        ...
        <el-col :lg="16" :md="20" :sm="24" :xs="24">
          <el-form :model="form" status-icon ref="form" label-width="100px" v-loading="loading" @submit.native.prevent>
            ...
            <el-form-item label="薪资">
              <el-input size="medium" v-model="form.salary_down" style="float: left;width: 20%" placeholder="请填写最低薪资"></el-input>
              <span style="float: left;">~</span>
              <el-input size="medium" v-model="form.salary_up" style="float: left;width: 20%" placeholder="请填写最高薪资"></el-input>
            </el-form-item>
